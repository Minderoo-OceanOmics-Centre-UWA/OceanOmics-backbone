...
*marine_verts.txt* - an OceanOmics-internal curated list of marine vertebrate species.

*big_tree.Actinopterygii.Chondrichtyes.tre* - the Betancur-R tree, the Rabosky tree, and the Stein tree merged, nothing else.

*big_tree.Actinopterygii.Chondrichtyes.withMarineVerts.tre* - the above tree with as many marine vertebrates added as possible. Where Genus was not present in the tree, the species was not added.
